...
public class ConfigPlayerSequence
{
    ...
    /// </summary>
    [JsonInclude]
    public float HeaderGroupWidthSize { get; set; } = 100F;
    ...
    /// </summary>
    [JsonInclude]
    public float NoteGroupOffHeightSize { get; set; } = 16F;
    ...
    /// </summary>
    [JsonInclude]
    public float NoteGroupOffWidthSize { get; set; } = 16F;

    /// <summary>
    /// ノート間隔：横
    /// </summary>
    [JsonInclude]
    public float NoteTermWidthSize { get; set; } = 10F;
    ...
    /// </summary>
    [JsonInclude]
    public float NoteGroupOnTermHeightSize { get; set; } = 14F;

    /// <summary>
    /// ノート間隔：縦：グループOFF時
    /// </summary>
    [JsonInclude]
    public float NoteGroupOffTermHeightSize { get; set; } = 14F;
