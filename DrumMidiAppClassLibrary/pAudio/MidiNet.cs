...
public static class MidiNet
{
    ...
    /// チャンネル番号リスト（0-15）
    /// </summary>
    public static List<byte> ChannelNoList { get; private set; } = new()
    {
    ...
    public static Dictionary<byte, string> DrumProgramList { get; private set; } = new()
    {
        {  0, "Standard"    },
        {  9, "Room"        },
        { 17, "Power"       },
