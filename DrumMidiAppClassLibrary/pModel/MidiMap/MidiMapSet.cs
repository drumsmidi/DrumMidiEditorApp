...
public class MidiMapSet : DisposeBaseClass
{
	...
	/// </summary>
	public Dictionary<PlayerSurfaceMode, Dictionary<int,MidiMapGroupPosition>> 
	...
	{
		var key = Config.System.MidiMapGroupKeyNotSelect;

		for ( var i = 0; i < Config.System.MidiMapGroupMaxNumber; i++ )
		{
	...
	{
		var key = Config.System.MidiMapKeyNotSelect;

		for ( var i = 0; i < Config.System.MidiMapMaxNumber; i++ )
		{
