...
public sealed partial class PageConfigPlayer : Page
{
	...
	/// <param name="sender"></param>
	/// <param name="ev"></param>
	private void ResolutionScreenComboBox_SelectedValueChanged( object sender, EventArgs ev )
	{
		try
		{
	...
	/// <param name="sender"></param>
	/// <param name="ev"></param>
	private void SheetColorButton_Click( object sender, EventArgs ev )
    {
		try
		{
			if ( !FormUtil.SelectColor( DrawSet.SheetColor, out var c ) )
			{
				return;
			}

			SheetColorButton.ForeColor	= c;
			Line128Button.BackColor		= c;
			Line64Button.BackColor		= c;
			Line32Button.BackColor		= c;
			Line16Button.BackColor		= c;
			DrawSet.SheetColor			= c;
	...
	/// <param name="sender"></param>
	/// <param name="ev"></param>
	private void PlayerSettingForm_FormClosing( object sender, FormClosingEventArgs ev )
	{
		try
		{
			ev.Cancel = true;
