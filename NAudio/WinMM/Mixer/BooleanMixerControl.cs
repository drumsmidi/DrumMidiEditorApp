...
public class BooleanMixerControl : MixerControl
{
    ...
    internal BooleanMixerControl( MixerInterop.MIXERCONTROL mixerControl, nint mixerHandle, MixerFlags mixerHandleType, int nChannels )
    {
    ...
    protected override void GetDetails( nint pDetails ) => boolDetails = Marshal.PtrToStructure<MixerInterop.MIXERCONTROLDETAILS_BOOLEAN>( pDetails );
