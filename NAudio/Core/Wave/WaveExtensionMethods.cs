...
public static class WaveExtensionMethods
{
    ...
    public static WaveFormat AsStandardWaveFormat( this WaveFormat waveFormat ) => waveFormat is WaveFormatExtensible wfe ? wfe.ToStandardWaveFormat() : waveFormat;
    ...
    public static IWaveProvider ToWaveProvider( this ISampleProvider sampleProvider ) => new SampleToWaveProvider( sampleProvider );
    ...
    public static IWaveProvider ToWaveProvider16( this ISampleProvider sampleProvider ) => new SampleToWaveProvider16( sampleProvider );
    ...
    public static ISampleProvider Skip( this ISampleProvider sampleProvider, TimeSpan skipDuration ) => new OffsetSampleProvider( sampleProvider ) { SkipOver = skipDuration };
    ...
    public static ISampleProvider Take( this ISampleProvider sampleProvider, TimeSpan takeDuration ) => new OffsetSampleProvider( sampleProvider ) { Take = takeDuration };
    ...
    public static ISampleProvider ToMono( this ISampleProvider sourceProvider, float leftVol = 0.5f, float rightVol = 0.5f )
    {
        return sourceProvider.WaveFormat.Channels == 1
            ? sourceProvider
            : new StereoToMonoSampleProvider( sourceProvider ) { LeftVolume = leftVol, RightVolume = rightVol };
    }
    ...
    {
        return sourceProvider.WaveFormat.Channels == 2
            ? sourceProvider
            : new MonoToStereoSampleProvider( sourceProvider ) { LeftVolume = leftVol, RightVolume = rightVol };
    }
}
