...
/// Editerタブ コントロール
/// </summary>
public partial class EditerControl : UserControl
{
	/// <summary>
	/// シート移動タイマー
	/// </summary>
    ...
    private void InitUpdate()
    {
		SuspendLayout();
        {
			int keta = Config.System.MeasureMaxNumber.ToString().Length;

			for ( int i = 0; i <= Config.System.MeasureMaxNumber; i++ )
			{
				MeasureNoListBox.Items.Add( i.ToString().PadLeft( keta, '0' ) );
			}
