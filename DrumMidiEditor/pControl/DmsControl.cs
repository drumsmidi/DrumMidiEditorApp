...
public static class DmsControl
{
	...
	public static double PlayNote( double aPlayTime )
	{
		...
		if ( _NoteSecPos == 0 )
		{
			return aPlayTime / _TimeTable[ _NoteSecPos + 1 ];
		}
		else
		{
			return _NoteSecPos + ( aPlayTime - _TimeTable[ _NoteSecPos ] ) / ( _TimeTable[ _NoteSecPos + 1 ] - _TimeTable[ _NoteSecPos ] );
		}
	}
						...
						case DmsState.DmsState_PrePlay:
							{
								...
								_BgmStartTime	= DMS.SCORE.BgmReproducePosition;
								_RangeStartTime	= 0;
