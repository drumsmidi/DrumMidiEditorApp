...
public static class Log
{
    ...
    /// ログ表示用フォーム
    /// </summary>
    private static readonly LogForm _LogForm = new();
    ...
    /// <param name="aText">出力内容</param>
    [Conditional("RELEASE")]
    private static void AddLog( string aText ) => _LogForm?.AddLog( aText );

    /// <summary>
    /// LogFormの表示切替
    /// </summary>
    [Conditional("RELEASE")]
    public static void ChangeDisplayLogForm() => _LogForm?.SetDisplay( !_LogForm.Visible );
    ...
    [Conditional("RELEASE")]
    public static void DisplayLogForm( bool aDisplay ) => _LogForm?.SetDisplay( aDisplay );
