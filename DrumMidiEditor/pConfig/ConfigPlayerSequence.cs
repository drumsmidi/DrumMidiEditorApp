...
public class ConfigPlayerSequence
{
    ...
    /// </summary>
    [JsonInclude]
    public int HeaderGroupWidthSize { get; set; } = 30;
    ...
    /// </summary>
    [JsonInclude]
    public int HeaderTotalWidthSize 
    ...
    /// </summary>
    [JsonInclude]
    public int NoteGroupOnTermHeightSize { get; set; } = 18;

    /// <summary>
    /// ノート間隔：縦：グループOFF時
    /// </summary>
    [JsonInclude]
    public int NoteGroupOffTermHeightSize { get; set; } = 6;
